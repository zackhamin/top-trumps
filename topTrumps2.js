...
alert("In this game we are playing against attack power!");

const roundOne = () => {
    if (play1.attack < play2.attack) {
        alert(`Player one uses ${play1.name} player two uses ${play2.name}`);
        alert(`Player one has an attack of ${play1.attack} and Player two has an attack of ${play2.attack} Player Two Wins this round!`)
        deck2.push(deck1[0])
        // console.log(deck2);
        // console.log("--------");        
        // console.log(deck1);
        ...
        alert(`Player one uses ${play1.name} player two uses ${play2.name}`);
        alert(`Player one has an attack of ${play1.attack} and Player two has an attack of ${play2.attack} Player One Wins this round!`)
}
}
